...
<html lang="es">
	...
	<link rel="stylesheet" type="text/css" href="cssbusquedadoctores/estilo.css"> 
...
<b><p>Categoria<input type="submit" value="Consultar Doctores" class="categoriabtn" disabled></p></b>
    
      

<!--AQUI SE ENLAZA LA CONEXION DE CONEXIONBUSCARPACIENTE.PHP POR MEDIO DE EL ID JAVASCRIT-->  

	<h1>BUSQUEDA DE DOCTORES</h1>
...
<!--ACA SALEN LOS DATOS DE LA CONEXION DE BUSCAR PACIENTES-->  
 ...
 <form action=pdfreportegeneraldoctores/index.php method=post> <input type="submit" value="Ver Reportes" class="btn btn-green3"></form>
    ...
    <?php
/*esta coneccion la hacemos desde la pag persona porque dese la conexiobuscar doctores no funciono*/
$per=new persona();
...
$per->eliminardoctores($_REQUEST["btneliminar"]);
    ...
    <script type="text/javascript" src="jsbusquedadoctores/jquery.min.js"></script>
<script type="text/javascript" src="jsbusquedadoctores/main.js"></script>
