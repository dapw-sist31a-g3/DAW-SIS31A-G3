...
<section class=seccion2>
 <br>
     ...
     <form action='editarpaciente.php?agregarpacientes.php' method="post" class=form1 name=form1 id="formEnviar">
         
         <b>
          <p>Categoria<input type="submit" value="Eeditar Pacientes" class="categoriabtn" disabled>
           </p>
...
$_SESSION["op"]=$_POST["opcion"];
$a=$_SESSION["op"];

$sql="select ID,NOMBRES,DUI,EDAD,DIRECCION,TELEFONO,NACIMIENTO from paciente where ID=$a";  
...
$sql="update paciente set ID='$id',NOMBRES='$nombre',DUI='$dui',EDAD='$edad',DIRECCION='$direccion',TELEFONO='$telefono',NACIMIENTO='$nacimiento' where id='$id'";
...
<tr>
<td colspan=2><input type="text" id=txtnacimiento name=txtnacimiento class="fieldnacimiento" value="<?php echo $row["NACIMIENTO"]?>" ><br></td>
</tr>
</table>
...
<br><br><br>
         ...
         <input type="submit" name=btnmodificar value="Actualizar Dato" class="btn btn-green3"   title="modifique">
...
<?php
if(isset($_REQUEST["btnmodificar"])){
header("location: agregarpacientes.php");
}
    ?>
</section>
