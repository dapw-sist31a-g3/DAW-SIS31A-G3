    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
	   ...
	   <!--este codigo ayuda para que cuando ingresemos datos al formulario ya apretemos el boton ingresar este tome los dato y haga la coneccion correcta con la base de datos--->
	    <script type="text/javascript">
            function cargar(nombre,dui,edad,especialidad,direccion){
...
<b><p>Categoria<input type="submit" value="Agregar Doctores" class="categoriabtn" disabled></p></b>
   ...
   <section class=seccion3>
       <p class="categoriabtn2">Nuevo Doctor</p>

<img src=iconos/agregardoc.png width="100px" data-toggle="modal" data-target=".bs-example-modal-sm" role=button>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
       ...
       <form action='#' method="post" name="frmpersona" class=form1>
         ...
         <b>
          <p>Categoria<input type="submit" value="Agregar Doctores" class="categoriabtn" disabled>
           </p>
...
ESPECIALIDAD:
<input type="text" name=txtespecialidad class="form-control"><br>


NACIMIENTO:
<input type="txt" name=txtdireccion class="form-control"><br>
...
$per->agregardoctores($_REQUEST["txtnombre"],$_REQUEST["txtdui"],$_REQUEST["txtedad"],$_REQUEST["txtespecialidad"],$_REQUEST["txtdireccion"]);

print $per->mostrardoctor();

    
}elseif(isset($_REQUEST["btneliminar"])){

$per->eliminardoctores($_REQUEST["btneliminar"]);
...
?>
 <form action=pdfreportegeneraldoctores/index.php method=post> <input type="submit" value="Ver Reportes" class="btn btn-green3"></form>
