...
<html lang="es">
	...
	<link rel="stylesheet" type="text/css" href="cssbusquedacitas/estilo.css"> 
...
<b><p>Categoria<input type="submit" value="Consultar Citas" class="categoriabtn" disabled></p></b>
...
$per->eliminarcitas($_REQUEST["btneliminar"]);
    ...
    <script type="text/javascript" src="jsbusquedacitas/jquery.min.js"></script>
<script type="text/javascript" src="jsbusquedacitas/main.js"></script>
